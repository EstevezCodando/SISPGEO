...
export function ReenviarAtivacao() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (!email.endsWith('@eb.mil.br')) {
      toast.error('Somente e-mails @eb.mil.br são aceitos')
      return
    }
    setLoading(true)
    try {
      ...
      const msg = e.response?.data?.detail ?? 'Erro ao reenviar o link de ativação'
          ...
          {enviado ? (
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm mt-2 leading-relaxed">
                  ...
                  cadastrado e pendente de confirmação, você receberá um novo link para
                  ativar sua conta. O link expira em{' '}
                  <span className="text-zinc-200">24 horas</span>.
                </p>
              </div>
              <div className="bg-zinc-800/60 border border-white/5 rounded-lg p-3 text-left">
                <p className="text-xs text-zinc-400 leading-relaxed">
                  ...
                  Verifique a caixa de spam ou aguarde alguns minutos. Entre reenvios é
                  necessário aguardar 30 minutos.
                </p>
                <p className="text-xs text-zinc-500 mt-1.5 leading-relaxed">
                  Em caso de dificuldades, entre em contato com a{' '}
                  <span className="text-zinc-400 font-medium">DSG</span> pelo telefone
                  (61) 3415-5237 ou 860-5237 (RITEx).
                </p>
              </div>
              <Link
                to="/login"
            ...
            <>
              <p className="text-zinc-400 text-sm mb-6 text-center leading-relaxed">
                Informe seu e-mail institucional. Se estiver cadastrado e pendente de
                confirmação, enviaremos um novo link de ativação.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  {loading ? 'Enviando…' : 'Reenviar link de ativação'}
                </button>
              </form>
